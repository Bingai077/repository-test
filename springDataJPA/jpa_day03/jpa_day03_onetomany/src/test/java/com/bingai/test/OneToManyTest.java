...
public class OneToManyTest {
    ...
    public void testAdd(){
        ...
        /**
         * 配置了客户到联系人的关系
         *   从客户的角度上，发送两条insert语句，发送了一条更新语句（更新外键）
    ...
    public void testAdd2(){
        ...
        linkMan.setCustomer(customer);//由于配置了多到一的关系（当保存的时候，已经对外键赋值了）
        customer.getLinkMans().add(linkMan);//由于配置了一到多的关系（发送一条update语句）
